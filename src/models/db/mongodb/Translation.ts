...
import { validate, IsNotEmpty, IsString, IsOptional, IsArray } from "class-validator";
...
/* ----------------------------- TYPEGOOSE MODEL ---------------------------- */
export const TranslationModel = getModelForClass(Translation, { schemaOptions: { timestamps: true } });
