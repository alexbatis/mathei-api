...
import { validate, IsNotEmpty, IsString, IsMongoId, IsArray, IsOptional } from "class-validator";
...
/* ----------------------------- TYPEGOOSE MODEL ---------------------------- */
export const LessonModel = getModelForClass(Lesson, { schemaOptions: { timestamps: true } });
