...
export class TodoItem {
  ...
  constructor(todoItem?: ITodoItem) {
    ...
    this.completed =
      todoItem && typeof todoItem.completed !== "undefined"
        ? todoItem.completed
        : null;
  }
  ...
  async updateAndValidate(updatedTodoItem?: ITodoItem) {
    this.description =
      (updatedTodoItem && updatedTodoItem.description) || this.description;
    this.completed =
      typeof updatedTodoItem.completed === "boolean"
        ? updatedTodoItem.completed
        : (updatedTodoItem && updatedTodoItem.completed) || this.completed;
